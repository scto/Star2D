...
public class EditorField implements EditorValue {
    ...
    public EditorField(final Context ctx, Editor mEditor, String nm, String mType) {
                ...
                for (String str : editor.getBodiesList()) {
                    ...
                    if (!nm.equals("Collision")) {
                        checkBox.setOnClickListener(vi -> {
                            ...
                            checkBox.setChecked(!nm.equals("parent") || check);
        ...
        if (type.equals("color")) {
            ...
            if (drag_control_fields.contains("," + getName() + ","))
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        ...
                        switch (ev) {
                            ...
                            case MotionEvent.ACTION_MOVE:
                                ...
                                if (getName().equals("height"))
                                    propertySet.put("Collider Height", propertySet.getFloat("Collider Height") + increase);
                                if (getName().equals("width"))
                                    propertySet.put("Collider Width", propertySet.getFloat("Collider Width") + increase);
            ...
            value = view.findViewById(R.id.value);
            name.setText(nm);
            value.setOnClickListener(v -> ImagesSelectorAdapter.show(v.getContext(), (path, dialog) -> {
        ...
        if (p.containsKey(name.getText().toString())) {
            ...
            if (type.equals("image")) {
                if (!imgPath.equals(p.getString(getName()))) {
                    ...
                    if (editor.getSelectedView() instanceof EditorItem)
                        ((EditorItem) (editor.getSelectedView())).setProperties(PropertySet.getPropertySet(editor.getSelectedView()));
                }
