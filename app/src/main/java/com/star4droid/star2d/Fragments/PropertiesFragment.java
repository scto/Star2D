...
public class PropertiesFragment extends Fragment {
    ...
    public void wrap() {
        try {
            if (view != null)
                view.setMinimumHeight(getContext().getResources().getDisplayMetrics().heightPixels * 5);
        } catch (Exception ex) {
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup arg1, Bundle arg2) {
        ...
        try {
            map = new Gson().fromJson(Utils.readAssetFile("types.json", getContext()), new TypeToken<HashMap<String, Object>>() {
            }.getType());
        } catch (Exception ex) {
            Utils.showMessage(getContext(), "Map init error : " + ex);
            return view;
        }
        ...
        try {
            ...
            Utils.showMessage(getContext(), "editor map error : " + ex);
            return view;
        }
        String details = "";
        for (String s : map.keySet()) {
